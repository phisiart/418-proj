...
## LLVM Query Compilation on Peloton

Extending LLVM query compilation for Peloton, an in-memory database management system.
Support INSERT, UPDATE, and DELETE queries based on the existing SCAN implementation.
Implement MemSQL-style parameterization and caching.
